  ...
  return (
    <div className="flex flex-col min-h-screen">
            ...
            <div className="space-y-12">
              <div className="bg-brand-blue/30 p-10 rounded-sm border border-brand-blue/50 reveal">
                ...
                <div className="mt-16 space-y-4">
                  <a
                      href={`https://wa.me/447385934662?text=${encodeURIComponent(`Hi, I'm interested in the ${car.year} ${car.brand} ${car.model} (£${(car.price ?? 0).toLocaleString()}). Is it still available?`)}`}
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 glass-effect border-t border-brand-blue/50 p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] flex space-x-4">
          <a
            href={`https://wa.me/447385934662?text=${encodeURIComponent(`Hi, I'm interested in the ${car.year} ${car.brand} ${car.model}`)}`}
